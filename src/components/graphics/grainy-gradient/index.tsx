import { Canvas, Fill, Shader, type SkRuntimeEffect, Skia } from '@shopify/react-native-skia';
// @ts-check
...
export const GrainyGradient: React.FC<IGrainyGradient> & React.FunctionComponent<IGrainyGradient> =
  memo<React.ComponentProps<typeof GrainyGradient> | IGrainyGradient>(
    ({
      width: paramsWidth,
      height: paramsHeight,
...
export default memo<React.FC<IGrainyGradient> & React.FunctionComponent<IGrainyGradient>>(
  GrainyGradient,
);
