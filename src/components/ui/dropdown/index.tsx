...
import { Modal, StyleSheet, TouchableOpacity, type View } from 'react-native';
...
const Content = ({ children, style, position = 'auto' }: ContentProps): JSX.Element | null => {
  ...
  const calculatePosition = useCallback(() => {
    ...
    if (position === 'auto') {
      ...
      const spaceAbove = y;
      const _spaceRight = SCREEN_WIDTH - x;
      const _spaceLeft = x;
...
const Item = ({ children, onPress, style, index = 0 }: ItemProps): JSX.Element => {
